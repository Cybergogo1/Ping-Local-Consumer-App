...
- **Header Section:**
  ...
  - Loyalty tier icon (displayed as avatar)
  - Current tier name display
  - Notification bell with unread count badge
  - Settings gear icon

- **Filter Bar:**
  - Location button (opens slide-out modal)
  - "Showing: [location]" indicator
  - Filter button with active count badge

- **Location Modal:**
  - Slide-out panel from left
  - List of available location areas
  - "All Locations" option
  - Only shows locations with active offers

- **Filter Modal:**
  - Slide-out panel from left
  - Categories section (single-select pills based on business categories)
  - Tags section (multi-select pills)
  - Clear All Filters button
  - Dynamic filtering (unavailable options are greyed out)
...
### 5.2 Offer Display
- **Offer Feed:**
  - Vertical scrolling list of offer cards
  - Pagination (loads 20 offers per page)
  - Load more on scroll
...
- **Map View Button:**
  ...
  - Opens interactive map view with business locations
...
### 12.1 Points System
- **Earning Rate:** 10 points per 10p spent (equivalent to 100 points per £1)
...
### 14.1 Account Screen
- **Profile Section:**
  - Tier icon (displayed as avatar)
  - User name display
  - Join date
  - Current tier title ("You're a [Tier]!")
  - Progress bar to next tier
  - Current points and points needed for next tier

- **Quick Stats:**
  - Pings Claimed (total offers claimed)
  - Pings Shared (offers shared with others)

- **Quick Access Cards:**
  - Loyalty Scheme card (links to tier information)
  - FAQs card

- **Redeemed Promotions:**
  - List of recently redeemed offers
  - Shows offer name, business, and redemption date
...
- Delete Account (with warning, redirects to support email)
